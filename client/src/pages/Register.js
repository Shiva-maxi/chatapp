    ...
    <div className="mt-5">
      <div className="bg-white  max-w-sm mx-3  p-4  rounded mx-auto">
        ...
        <form className="grid gap-3 mt-4" onSubmit={handlesubmit}>
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="px-2 py-1 bg-slate-200 focus:outline-primary"
          ...
          <button className="bg-primary text-lg py-1 px-3 hover:bg-secondary rounded mt-3">
            Register
          </button>
        </form>
        <p className="text-center mt-4">
          ...
          <Link to={"/email"}>
            {" "}
            <span className="hover:text-primary font-semibold">Login</span>
          </Link>{" "}
        </p>
      </div>
    </div>
